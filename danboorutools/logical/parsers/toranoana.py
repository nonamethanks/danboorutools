    ...
    def _match_img(parsable_url: ParsableUrl) -> ToranoanaUrl | None:
        match parsable_url.url_parts:
            ...
            case "ec", "img", _, _, _, _, _:
                [post_id, page] = parsable_url.stem.removesuffix("_thumb").split("-")
                return ToranoanaImageUrl(parsed_url=parsable_url,
                                         post_id=post_id,
                                         page=int(page.removesuffix("p")))
    ...
    def _match_everything_else(cls, parsable_url: ParsableUrl) -> ToranoanaUrl | UselessUrl | None:
        match parsable_url.url_parts:
            ...
            case subdir1, ("ec" | "digi") as subdir2, "item", item_id:
                ...
                subsite = parsable_url.subdomain if parsable_url.subdomain != "www" else "ec"
                return ToranoanaItemUrl(parsed_url=parsable_url,
                                        item_id=item_id,
                                        subsite=parsable_url.subdomain,
                                        subdirs=f"{subdir1}/ec")
            ...
            case subdir1,  ("ec" | "digi") as subdir2, "app", "catalog", "list":
                ...
                if artist_name := parsable_url.query.get("actorKindId"):
                    artist_type = "actorKindId"
                elif artist_name := parsable_url.query.get("searchActorName"):
                    artist_type = "searchActorName"
                else:
                    return None
                return ToranoanaArtistUrl(parsed_url=parsable_url,
                                          subdirs=f"{subdir1}/{subdir2}",
                                          subsite=parsable_url.subdomain,
            ...
            case subdir, "article", _, _, _, _, item_id:
                ...
                return ToranoanaItemUrl(parsed_url=parsable_url,
                                        item_id=item_id.removesuffix(".html"),
                                        subsite=subsite,
                                        subdirs=f"{subdir}/ec")
            ...
            case subdir1, ("ec" | "digi") as subdir2, ("cot" | "cit" | "ebk") as subdir3, "circle", circle_id, "all":
                ...
                return ToranoanaCircleUrl(parsed_url=parsable_url,
                                          circle_id=circle_id,
                                          subdirs=f"{subdir1}/{subdir2}/{subdir3}",
                                          subsite=parsable_url.subdomain)
            ...
            case "webcomic", "holic", publisher, "webcomic", "4koma", webcomic_title, webcomic_entry, _filename:
                return ToranoanaWebcomicPageUrl(parsed_url=parsable_url,
                                                publisher=publisher,
                                                webcomic_title=webcomic_title,
                                                webcomic_entry=webcomic_entry)
            ...
            case "info", "dojin", dojin_slug:
                return ToranoanaDojinSeriesUrl(parsed_url=parsable_url,
                                               dojin_slug=dojin_slug)
            ...
            case ("bl" | "mailorder"), ("cot" | "cit" | "ebk"), "author", _, _:
                return ToranoanaOldAuthorUrl(parsed_url=parsable_url)
            ...
            case ("bl" | "mailorder"),  ("cot" | "cit" | "ebk"), "circle", _, _, _circle_id, _:
                return ToranoanaOldCircleUrl(parsed_url=parsable_url)
