...
from danboorutools.logical.strategies.deviantart import DeviantArtArtistUrl, DeviantArtImageUrl, DeviantArtPostUrl, DeviantArtUrl
    ...
    def _match_username_in_path(parsable_url: ParsableUrl) -> DeviantArtUrl | None:
        ...
        match parsable_url.url_parts:
            ...
            case "deviation", deviation_id:
                instance = DeviantArtPostUrl(parsable_url.url)
