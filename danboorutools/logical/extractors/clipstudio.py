...
class ClipStudioUserSearchUrl(ArtistUrl, ClipStudioUrl):
    username: str
    normalize_string = "https://assets.clip-studio.com/ja-jp/search?user={username}"
...
class ClipStudioAssetPostUrl(PostUrl, ClipStudioUrl):
    asset_id: int
    normalize_string = "https://assets.clip-studio.com/ja-jp/detail?id={asset_id}"
...
class ClipStudioProfileUrl(InfoUrl, ClipStudioUrl):
    profile_id: str
    normalize_string = "https://profile.clip-studio.com/ja-jp/profile/{profile_id}"
